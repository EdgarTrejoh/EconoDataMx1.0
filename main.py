        ...
        if df_IE004 is not None:
            ...
            with tabs[0]:  # Pestaña de Inflacion
                ...
                with st.form("form_indicador_inflacion"):
                    ...
                    start_Date = st.date_input("Fecha de inicio", datetime.date(2008, 1, 21), datetime.date(2008, 1, 21),datetime.date(2025, 3, 1),"start")
                    end_Date = st.date_input("Fecha de fin", datetime.date(2008, 1, 21), datetime.date(2008, 1, 21),datetime.date(2025, 3, 1), "end")
